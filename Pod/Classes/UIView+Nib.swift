...
extension UIView {
    ...
    public static func or_loadFromNib() -> UIView {
        return or_loadFromNib(owner: nil)
    }
    
    public static func or_loadFromNib(owner: AnyObject?) -> UIView {
        let v = Bundle(for: self.classForCoder()).loadNibNamed(String(describing: self), owner: owner, options: nil)!.first
        return v as! UIView
    }
    
    public static func or_loadFromNib(containerToFill: UIView) -> UIView {
        return or_loadFromNib(containerToFill: containerToFill, owner: nil)
    }
    
    public static func or_loadFromNib(containerToFill: UIView, owner: AnyObject?) -> UIView {
