...
#   * Finally, don't worry about the indent, CocoaPods strips it!  
  s.description      = "UIScrollView+KeyboardInsetHandler, ORKeyboardLayoutConstraint, ORDependentOnScreenScaleSeparator, UIView+HideKeyboard, UIViewController+Alert, ORGradientView, ORRoundRectButton, ORTopViewController (find topmost vc) etc."
